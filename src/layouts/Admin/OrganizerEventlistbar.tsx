        ...
        <div className="w-full flex flex-col text-[#777E90]">
            <div className="w-full flex flex-row justify-center items-center">
                <div className="flex my-[10px] sm:mt-8">
                    ...
                    <button onClick={Organizersbutton} className="block justify-center bg-transparent rounded-[14px] w-[150px] items-center text-grayColor hover:bg-[#58BD7D] hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#c6e6d2]">
                        <p className="text-lg font-bold text-current">Organizers</p>
                    </button>
                    <button onClick={Reportbutton} className="block justify-center bg-transparent rounded-[14px] w-[110px] items-center text-grayColor hover:bg-[#58BD7D] hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#c6e6d2]">
            ...
            {/* <div className="w-full flex sm:flex-col lg:px-40 md:px-[39px] sm:px-[16px] py-5 justify-between">
                ...
                <div className="flex my-[10px] sm:mt-8">
                    ...
                    <button className="justify-center flex bg-transparent rounded-[14px] w-[85px] items-center mr-3">
                        <p className="text-lg font-bold text-current">Online</p>
                    </button>
                    <button className="justify-center flex bg-transparent rounded-[14px] w-[85px] items-center">
                        <p className="text-lg font-bold text-current">Offline</p>
                    </button>
                </div>
            </div> */}
        </div>
